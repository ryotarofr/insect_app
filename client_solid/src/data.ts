...
export type RouteKey =
  ...
  | "product-detail"
  | "specimen"
  // 個体登録ページ (/specimens/new)
  | "specimen-new"
  // 飼育 (cohort) 一覧
  | "cohort"
  // 群詳細 (/cohorts/:id)
  | "cohort-detail"
  // 個体化モード (/cohorts/:id/promote)
  | "cohort-promote"
  // 群を作成 (/cohorts/new)
  | "cohort-new"
  | "eclosion"
  | "bloodline"
  // "cart" は SDUI 駆動の CartSduiPage に統一。
  //   cart_items が listing_id を持ち、出品の購入経路として再利用。
  | "cart"
  | "warranty"
  // login / register UI を表示する route
  | "login"
  // 自分の注文履歴 / 詳細 (「取引履歴」として運用)
  | "orders"
  | "order-detail"
  // 出品作成ページ (/listings/new)
  | "listing-new"
  // 自分の出品管理ページ (/listings/me) — タブ式の縦リスト全件表示
  | "my-listings"
  // Stripe Connect onboarding 後の return ページ

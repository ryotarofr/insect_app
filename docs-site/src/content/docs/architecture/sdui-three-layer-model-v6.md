---
title: "SDUI 三層モデル 設計方針 v6"
description: "SDUI v6 設計仕様書 (現行・正典)。Region → Block → Role の三層モデル、deserialize 規律、テンプレート毎の Regions 定義など。"
sidebar:
  order: 10
---
...
| 集約された TS 型 | `client_solid/src/generated/sdui.ts` (680 行)
